...
class InvoiceController extends Controller
{
    public function index(Request $request,$orderid){
        ...
        $order_data=OrderDetail:: join('orders','orders.id','=','order_details.order_id')
            ...
            ->select('orders.refid as refrerid','orders.id as oid','orders.echo_charges','orders.created_at','orders.delivery_date','orders.bags_no','orders.crate_no','partners.name as pname','partners.address','partners.mobile as pmobile','partners.house_no as phouse_no','partners.city as pcity','partners.pincode as ppincode','partners.state as pstate',
