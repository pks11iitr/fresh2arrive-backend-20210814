...
<head>
    ...
    <style>
        ...
        .city_list li{width:31%;margin: 0px 0 20px;}
        .city_list{display: flex;list-style-type: none;margin:15px 0 0;padding:0;flex-flow: wrap;justify-content:space-between;}
        ...
        .servicble_area{margin:0;padding:0;list-style-type:none;font-family: 'Nunito';display: flex;justify-content: space-between;flex-flow: wrap;}
        .servicble_area li{border: 1px solid #ccc;
            border-radius: 3px;
            padding: 8px 13px;
            font-size: 12px;width: 25%;margin:15px 0 0}
