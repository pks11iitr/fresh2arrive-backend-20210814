    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="{{route('dashboard')}}" class="brand-link">
           <img src="{{asset('admin-theme/img/AdminLTELogo.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                 style="opacity: .8">
            <span class="brand-text font-weight-light">Fresh2Arrive CMS</span>
        </a>
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                ...
                <div class="info">
                    <a href="{{route('dashboard')}}" class="d-block">Fresh2Arrive</a>
                </div>
            </div>
...
{{--                        </ul>--}}
                    ...
                    <li class="nav-item">
                        <a href="{{route('notification.list')}}" class="nav-link">
                            <i class="nav-icon fas fa-th"></i>
                            <p>
                                Notifications
                            </p>
