...
return [
     ...
     * ------------------------------------------------------------------------
     */
    'default' => env('FIREBASE_PROJECT', 'customer'),
    ...
    'projects' => [
        'customer' => [
             ...
             */
            'credentials' => [
                'file' => env('FIREBASE_CREDENTIALS_CUSTOMER', env('GOOGLE_APPLICATION_CREDENTIALS')),
        ...
        'partner' => [
             ...
             */
            'credentials' => [
                'file' => env('FIREBASE_CREDENTIALS_PARTNER', env('GOOGLE_APPLICATION_CREDENTIALS')),
